...
#SBATCH -J methanol_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots10000000
...
echo "methanol_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots10000000"
python "methanol_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots10000000.py"
echo "File run"
