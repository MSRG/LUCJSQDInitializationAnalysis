...
#SBATCH -J methanol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots10000
...
echo "methanol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots10000"
python "methanol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots10000.py"
echo "File run"
