...
#SBATCH -J buta-1,3-diene_LUCJ_L2_STO-3G_random_StateVector_Shots10000
...
echo "buta-1,3-diene_LUCJ_L2_STO-3G_random_StateVector_Shots10000"
python "buta-1,3-diene_LUCJ_L2_STO-3G_random_StateVector_Shots10000.py"
echo "File run"
