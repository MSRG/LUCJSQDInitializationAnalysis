...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_ML_exact
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_ML_exact"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_ML_exact.py"
echo "File run"    
