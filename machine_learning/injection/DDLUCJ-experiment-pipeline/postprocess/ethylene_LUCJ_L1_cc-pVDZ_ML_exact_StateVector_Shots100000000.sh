...
#SBATCH -J ethylene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000
...
echo "ethylene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000"
python "ethylene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000.py"
echo "File run"
