...
#SBATCH -J ammonia_LUCJ_L1_cc-pVDZ_MP2_StateVector_Shots1000000
...
echo "ammonia_LUCJ_L1_cc-pVDZ_MP2_StateVector_Shots1000000"
python "ammonia_LUCJ_L1_cc-pVDZ_MP2_StateVector_Shots1000000.py"
echo "File run"
