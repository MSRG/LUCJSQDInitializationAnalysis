...
#SBATCH -J ethylene_LUCJ_L1_STO-3G_ML_StateVector_Shots10000000
...
echo "ethylene_LUCJ_L1_STO-3G_ML_StateVector_Shots10000000"
python "ethylene_LUCJ_L1_STO-3G_ML_StateVector_Shots10000000.py"
echo "File run"
