...
#SBATCH -J ammonia_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots1000000
...
echo "ammonia_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots1000000"
python "ammonia_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots1000000.py"
echo "File run"
