...
#SBATCH -J methanol_LUCJ_L5_cc-pVDZ_random_StateVector_Shots1000000
...
echo "methanol_LUCJ_L5_cc-pVDZ_random_StateVector_Shots1000000"
python "methanol_LUCJ_L5_cc-pVDZ_random_StateVector_Shots1000000.py"
echo "File run"
