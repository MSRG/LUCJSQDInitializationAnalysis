...
#SBATCH -J but-1-yne_LUCJ_L4_STO-3G_zeroes_StateVector_Shots100000000
...
echo "but-1-yne_LUCJ_L4_STO-3G_zeroes_StateVector_Shots100000000"
python "but-1-yne_LUCJ_L4_STO-3G_zeroes_StateVector_Shots100000000.py"
echo "File run"
