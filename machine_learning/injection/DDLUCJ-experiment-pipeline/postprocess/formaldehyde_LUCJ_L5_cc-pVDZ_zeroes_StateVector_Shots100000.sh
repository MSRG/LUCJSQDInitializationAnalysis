...
#SBATCH -J formaldehyde_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "formaldehyde_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000"
python "formaldehyde_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
