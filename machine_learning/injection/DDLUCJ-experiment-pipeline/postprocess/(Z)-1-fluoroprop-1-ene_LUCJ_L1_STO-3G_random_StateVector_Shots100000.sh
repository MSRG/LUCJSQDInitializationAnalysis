...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L1_STO-3G_random_StateVector_Shots100000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L1_STO-3G_random_StateVector_Shots100000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L1_STO-3G_random_StateVector_Shots100000.py"
echo "File run"
