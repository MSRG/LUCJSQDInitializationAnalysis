...
#SBATCH -J water_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "water_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots1000000"
python "water_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
