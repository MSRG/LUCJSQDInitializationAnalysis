...
#SBATCH -J methane_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000
...
echo "methane_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000"
python "methane_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000.py"
echo "File run"
