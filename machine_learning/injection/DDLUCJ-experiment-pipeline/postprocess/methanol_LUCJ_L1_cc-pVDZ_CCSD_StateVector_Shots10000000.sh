...
#SBATCH -J methanol_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000
...
echo "methanol_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000"
python "methanol_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000.py"
echo "File run"
