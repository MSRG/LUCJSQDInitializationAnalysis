...
#SBATCH -J formaldehyde_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots10000000
...
echo "formaldehyde_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots10000000"
python "formaldehyde_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots10000000.py"
echo "File run"
