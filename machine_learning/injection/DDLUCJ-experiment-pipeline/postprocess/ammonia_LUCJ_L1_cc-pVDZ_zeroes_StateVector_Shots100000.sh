...
#SBATCH -J ammonia_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "ammonia_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000"
python "ammonia_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
