...
#SBATCH -J buta-1,3-diene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000
...
echo "buta-1,3-diene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000"
python "buta-1,3-diene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
