...
#SBATCH -J ethane_LUCJ_L3_STO-3G_zeroes_StateVector_Shots100000
...
echo "ethane_LUCJ_L3_STO-3G_zeroes_StateVector_Shots100000"
python "ethane_LUCJ_L3_STO-3G_zeroes_StateVector_Shots100000.py"
echo "File run"
