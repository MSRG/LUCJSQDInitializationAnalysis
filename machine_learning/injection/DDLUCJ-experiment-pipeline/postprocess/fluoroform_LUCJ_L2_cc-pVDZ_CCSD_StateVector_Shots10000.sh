...
#SBATCH -J fluoroform_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots10000
...
echo "fluoroform_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots10000"
python "fluoroform_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots10000.py"
echo "File run"
