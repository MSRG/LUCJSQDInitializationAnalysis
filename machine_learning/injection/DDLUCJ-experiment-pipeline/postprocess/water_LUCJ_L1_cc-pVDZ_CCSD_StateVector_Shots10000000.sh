...
#SBATCH -J water_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000
...
echo "water_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000"
python "water_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots10000000.py"
echo "File run"
