...
#SBATCH -J ethylene_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots100000
...
echo "ethylene_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots100000"
python "ethylene_LUCJ_L3_cc-pVDZ_MP2_StateVector_Shots100000.py"
echo "File run"
