...
#SBATCH -J but-1-yne_LUCJ_L5_cc-pVDZ_random_StateVector_Shots10000000
...
echo "but-1-yne_LUCJ_L5_cc-pVDZ_random_StateVector_Shots10000000"
python "but-1-yne_LUCJ_L5_cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
