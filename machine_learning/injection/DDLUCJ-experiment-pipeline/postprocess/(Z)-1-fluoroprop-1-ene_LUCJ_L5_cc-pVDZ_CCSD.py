...
counts = np.load(f"../counts/(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_CCSD.npz")
...
EnergyPath = f"../energies/(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_CCSD.txt" 
with open(EnergyPath,'w') as f:
    new_row={"Basis Set": "cc-pVDZ", "Molecule": "(Z)-1-fluoroprop-1-ene", "Method": f"LUCJ(L=5)/CCSD", "Energy": new_energy}
