...
#SBATCH -J buta-1,3-diene_LUCJ_L2_aug-cc-pVDZ_ML_exact
...
echo "buta-1,3-diene_LUCJ_L2_aug-cc-pVDZ_ML_exact"
python "buta-1,3-diene_LUCJ_L2_aug-cc-pVDZ_ML_exact.py"
echo "File run"    
