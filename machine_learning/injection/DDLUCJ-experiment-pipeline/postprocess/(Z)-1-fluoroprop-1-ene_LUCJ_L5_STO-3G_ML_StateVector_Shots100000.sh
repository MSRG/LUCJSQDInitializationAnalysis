...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_ML_StateVector_Shots100000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_ML_StateVector_Shots100000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_ML_StateVector_Shots100000.py"
echo "File run"
