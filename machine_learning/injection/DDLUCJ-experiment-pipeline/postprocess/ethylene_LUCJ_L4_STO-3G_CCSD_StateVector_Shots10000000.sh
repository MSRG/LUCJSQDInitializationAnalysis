...
#SBATCH -J ethylene_LUCJ_L4_STO-3G_CCSD_StateVector_Shots10000000
...
echo "ethylene_LUCJ_L4_STO-3G_CCSD_StateVector_Shots10000000"
python "ethylene_LUCJ_L4_STO-3G_CCSD_StateVector_Shots10000000.py"
echo "File run"
