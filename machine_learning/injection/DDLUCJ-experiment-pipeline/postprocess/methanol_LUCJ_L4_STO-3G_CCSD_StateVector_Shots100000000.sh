...
#SBATCH -J methanol_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000000
...
echo "methanol_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000000"
python "methanol_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000000.py"
echo "File run"
