...
#SBATCH -J buta-1,3-diene_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "buta-1,3-diene_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots1000000"
python "buta-1,3-diene_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
