...
#SBATCH -J ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots10000000
...
echo "ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots10000000"
python "ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
