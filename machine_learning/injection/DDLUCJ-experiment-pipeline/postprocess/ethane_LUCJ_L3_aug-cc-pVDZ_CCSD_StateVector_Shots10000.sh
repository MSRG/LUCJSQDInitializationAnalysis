...
#SBATCH -J ethane_LUCJ_L3_aug-cc-pVDZ_CCSD_StateVector_Shots10000
...
echo "ethane_LUCJ_L3_aug-cc-pVDZ_CCSD_StateVector_Shots10000"
python "ethane_LUCJ_L3_aug-cc-pVDZ_CCSD_StateVector_Shots10000.py"
echo "File run"
