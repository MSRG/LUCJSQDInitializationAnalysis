...
#SBATCH -J prop-2-en-1-ol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000
...
echo "prop-2-en-1-ol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000"
python "prop-2-en-1-ol_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000.py"
echo "File run"
