...
#SBATCH -J methanol_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000000
...
echo "methanol_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000000"
python "methanol_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000000.py"
echo "File run"
