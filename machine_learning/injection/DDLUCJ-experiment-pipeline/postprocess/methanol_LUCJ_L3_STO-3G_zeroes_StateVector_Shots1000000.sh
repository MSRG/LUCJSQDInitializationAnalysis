...
#SBATCH -J methanol_LUCJ_L3_STO-3G_zeroes_StateVector_Shots1000000
...
echo "methanol_LUCJ_L3_STO-3G_zeroes_StateVector_Shots1000000"
python "methanol_LUCJ_L3_STO-3G_zeroes_StateVector_Shots1000000.py"
echo "File run"
