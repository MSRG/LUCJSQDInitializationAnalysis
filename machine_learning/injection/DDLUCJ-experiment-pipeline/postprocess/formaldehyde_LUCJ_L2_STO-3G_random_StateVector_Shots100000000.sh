...
#SBATCH -J formaldehyde_LUCJ_L2_STO-3G_random_StateVector_Shots100000000
...
echo "formaldehyde_LUCJ_L2_STO-3G_random_StateVector_Shots100000000"
python "formaldehyde_LUCJ_L2_STO-3G_random_StateVector_Shots100000000.py"
echo "File run"
