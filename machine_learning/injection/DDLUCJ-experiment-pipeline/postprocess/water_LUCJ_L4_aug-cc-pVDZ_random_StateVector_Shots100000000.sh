...
#SBATCH -J water_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots100000000
...
echo "water_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots100000000"
python "water_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots100000000.py"
echo "File run"
