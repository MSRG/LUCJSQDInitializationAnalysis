...
#SBATCH -J ethylene_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots100000
...
echo "ethylene_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots100000"
python "ethylene_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots100000.py"
echo "File run"
