...
#SBATCH -J buta-1,3-diene_LUCJ_L3_STO-3G_ML_exact_StateVector_Shots100000
...
echo "buta-1,3-diene_LUCJ_L3_STO-3G_ML_exact_StateVector_Shots100000"
python "buta-1,3-diene_LUCJ_L3_STO-3G_ML_exact_StateVector_Shots100000.py"
echo "File run"
