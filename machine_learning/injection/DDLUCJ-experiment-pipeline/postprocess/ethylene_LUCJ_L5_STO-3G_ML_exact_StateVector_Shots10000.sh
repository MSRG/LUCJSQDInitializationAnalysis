...
#SBATCH -J ethylene_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000
...
echo "ethylene_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000"
python "ethylene_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000.py"
echo "File run"
