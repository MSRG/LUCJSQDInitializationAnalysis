...
#SBATCH -J prop-2-en-1-ol_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots100000000
...
echo "prop-2-en-1-ol_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots100000000"
python "prop-2-en-1-ol_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots100000000.py"
echo "File run"
