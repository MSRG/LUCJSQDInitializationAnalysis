...
#SBATCH -J ethylene_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots10000000
...
echo "ethylene_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots10000000"
python "ethylene_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots10000000.py"
echo "File run"
