...
#SBATCH -J ammonia_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000
...
echo "ammonia_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000"
python "ammonia_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000.py"
echo "File run"
