...
#SBATCH -J fluoroform_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "fluoroform_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots1000000"
python "fluoroform_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
