...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
