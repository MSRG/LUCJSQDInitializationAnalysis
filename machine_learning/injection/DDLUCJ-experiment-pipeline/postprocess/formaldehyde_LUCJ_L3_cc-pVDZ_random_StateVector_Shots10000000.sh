...
#SBATCH -J formaldehyde_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000
...
echo "formaldehyde_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000"
python "formaldehyde_LUCJ_L3_cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
