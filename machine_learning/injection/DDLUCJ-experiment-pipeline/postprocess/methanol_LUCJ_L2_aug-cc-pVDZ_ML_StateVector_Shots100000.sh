...
#SBATCH -J methanol_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000
...
echo "methanol_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000"
python "methanol_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000.py"
echo "File run"
