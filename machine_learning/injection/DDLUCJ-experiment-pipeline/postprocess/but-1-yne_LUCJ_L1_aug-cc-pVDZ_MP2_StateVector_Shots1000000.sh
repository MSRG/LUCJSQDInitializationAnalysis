...
#SBATCH -J but-1-yne_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots1000000
...
echo "but-1-yne_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots1000000"
python "but-1-yne_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots1000000.py"
echo "File run"
