...
#SBATCH -J methane_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000
...
echo "methane_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000"
python "methane_LUCJ_L2_aug-cc-pVDZ_ML_StateVector_Shots100000.py"
echo "File run"
