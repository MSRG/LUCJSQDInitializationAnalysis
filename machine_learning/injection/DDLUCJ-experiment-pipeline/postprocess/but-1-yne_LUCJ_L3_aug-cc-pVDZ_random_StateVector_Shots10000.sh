...
#SBATCH -J but-1-yne_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000
...
echo "but-1-yne_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000"
python "but-1-yne_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000.py"
echo "File run"
