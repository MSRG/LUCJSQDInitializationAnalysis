...
#SBATCH -J buta-1,3-diene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000
...
echo "buta-1,3-diene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000"
python "buta-1,3-diene_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000.py"
echo "File run"
