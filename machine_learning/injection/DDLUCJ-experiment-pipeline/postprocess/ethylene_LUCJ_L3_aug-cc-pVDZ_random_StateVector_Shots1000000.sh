...
#SBATCH -J ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots1000000"
python "ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots1000000.py"
echo "File run"
