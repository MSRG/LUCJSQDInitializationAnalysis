...
new_energy, subspace = initDDLUCJ(postprocess=True,BitArray=bitstrings,usefulqrum=True,bitarraypath=f"../counts/buta-1,3-diene_LUCJ_L4_STO-3G_CCSD.npz") 

EnergyPath = f"../energies/buta-1,3-diene_LUCJ_L4_STO-3G_CCSD.txt" 

with open(EnergyPath,'w') as f:
    new_row={"Basis Set": "STO-3G", "Molecule": "buta-1,3-diene", "Method": f"LUCJ(L=4)/CCSD", "Energy": new_energy}
