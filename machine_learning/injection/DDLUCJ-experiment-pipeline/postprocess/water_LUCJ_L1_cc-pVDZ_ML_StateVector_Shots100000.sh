...
#SBATCH -J water_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000
...
echo "water_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000"
python "water_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000.py"
echo "File run"
