...
#SBATCH -J ethane_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000
...
echo "ethane_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000"
python "ethane_LUCJ_L1_cc-pVDZ_ML_exact_StateVector_Shots100000000.py"
echo "File run"
