...
#SBATCH -J methane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "methane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots1000000"
python "methane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
