...
#SBATCH -J ethane_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "ethane_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000"
python "ethane_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
