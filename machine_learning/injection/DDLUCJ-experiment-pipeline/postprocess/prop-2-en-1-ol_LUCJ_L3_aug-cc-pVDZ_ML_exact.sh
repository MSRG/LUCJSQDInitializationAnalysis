...
#SBATCH -J prop-2-en-1-ol_LUCJ_L3_aug-cc-pVDZ_ML_exact
...
echo "prop-2-en-1-ol_LUCJ_L3_aug-cc-pVDZ_ML_exact"
python "prop-2-en-1-ol_LUCJ_L3_aug-cc-pVDZ_ML_exact.py"
echo "File run"    
