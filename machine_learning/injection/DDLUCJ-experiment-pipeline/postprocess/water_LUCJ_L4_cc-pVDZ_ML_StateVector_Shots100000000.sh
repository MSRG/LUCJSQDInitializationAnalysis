...
#SBATCH -J water_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots100000000
...
echo "water_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots100000000"
python "water_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots100000000.py"
echo "File run"
