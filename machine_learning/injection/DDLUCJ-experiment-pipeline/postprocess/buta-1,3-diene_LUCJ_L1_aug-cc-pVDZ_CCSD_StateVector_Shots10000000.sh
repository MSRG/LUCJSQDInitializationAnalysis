...
#SBATCH -J buta-1,3-diene_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots10000000
...
echo "buta-1,3-diene_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots10000000"
python "buta-1,3-diene_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots10000000.py"
echo "File run"
