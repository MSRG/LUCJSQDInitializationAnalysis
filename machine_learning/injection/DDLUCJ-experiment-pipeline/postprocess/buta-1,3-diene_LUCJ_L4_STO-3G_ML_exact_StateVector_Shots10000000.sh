...
#SBATCH -J buta-1,3-diene_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000
...
echo "buta-1,3-diene_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000"
python "buta-1,3-diene_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000.py"
echo "File run"
