...
#SBATCH -J buta-1,3-diene_LUCJ_L3_STO-3G_MP2_StateVector_Shots100000000
...
echo "buta-1,3-diene_LUCJ_L3_STO-3G_MP2_StateVector_Shots100000000"
python "buta-1,3-diene_LUCJ_L3_STO-3G_MP2_StateVector_Shots100000000.py"
echo "File run"
