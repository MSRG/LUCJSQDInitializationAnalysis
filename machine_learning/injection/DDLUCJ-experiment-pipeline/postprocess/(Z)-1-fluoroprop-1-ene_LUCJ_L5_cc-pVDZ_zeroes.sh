...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_zeroes
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_zeroes"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L5_cc-pVDZ_zeroes.py"
echo "File run"    
