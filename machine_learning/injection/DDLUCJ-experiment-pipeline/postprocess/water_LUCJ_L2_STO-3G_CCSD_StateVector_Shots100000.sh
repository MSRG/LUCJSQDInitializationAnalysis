...
#SBATCH -J water_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000
...
echo "water_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000"
python "water_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000.py"
echo "File run"
