...
#SBATCH -J but-1-yne_LUCJ_L2_aug-cc-pVDZ_random_StateVector_Shots100000
...
echo "but-1-yne_LUCJ_L2_aug-cc-pVDZ_random_StateVector_Shots100000"
python "but-1-yne_LUCJ_L2_aug-cc-pVDZ_random_StateVector_Shots100000.py"
echo "File run"
