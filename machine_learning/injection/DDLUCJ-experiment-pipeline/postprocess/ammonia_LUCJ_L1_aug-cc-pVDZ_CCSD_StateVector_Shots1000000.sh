...
#SBATCH -J ammonia_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots1000000
...
echo "ammonia_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots1000000"
python "ammonia_LUCJ_L1_aug-cc-pVDZ_CCSD_StateVector_Shots1000000.py"
echo "File run"
