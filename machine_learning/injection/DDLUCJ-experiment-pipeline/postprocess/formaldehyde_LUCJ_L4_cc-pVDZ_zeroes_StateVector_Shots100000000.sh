...
#SBATCH -J formaldehyde_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots100000000
...
echo "formaldehyde_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots100000000"
python "formaldehyde_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots100000000.py"
echo "File run"
