...
#SBATCH -J formaldehyde_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots10000
...
echo "formaldehyde_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots10000"
python "formaldehyde_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots10000.py"
echo "File run"
