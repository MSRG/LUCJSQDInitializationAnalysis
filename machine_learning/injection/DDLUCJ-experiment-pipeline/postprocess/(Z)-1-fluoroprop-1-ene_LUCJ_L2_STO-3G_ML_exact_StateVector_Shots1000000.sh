...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots1000000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots1000000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots1000000.py"
echo "File run"
