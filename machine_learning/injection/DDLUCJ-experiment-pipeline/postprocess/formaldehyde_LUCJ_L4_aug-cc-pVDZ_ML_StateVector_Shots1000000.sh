...
#SBATCH -J formaldehyde_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots1000000
...
echo "formaldehyde_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots1000000"
python "formaldehyde_LUCJ_L4_aug-cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
