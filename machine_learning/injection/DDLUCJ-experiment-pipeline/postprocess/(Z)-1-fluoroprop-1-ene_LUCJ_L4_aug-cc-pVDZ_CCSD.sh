...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_CCSD
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_CCSD"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_CCSD.py"
echo "File run"    
