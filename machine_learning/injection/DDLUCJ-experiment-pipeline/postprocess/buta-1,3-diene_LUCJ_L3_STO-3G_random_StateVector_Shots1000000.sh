...
#SBATCH -J buta-1,3-diene_LUCJ_L3_STO-3G_random_StateVector_Shots1000000
...
echo "buta-1,3-diene_LUCJ_L3_STO-3G_random_StateVector_Shots1000000"
python "buta-1,3-diene_LUCJ_L3_STO-3G_random_StateVector_Shots1000000.py"
echo "File run"
