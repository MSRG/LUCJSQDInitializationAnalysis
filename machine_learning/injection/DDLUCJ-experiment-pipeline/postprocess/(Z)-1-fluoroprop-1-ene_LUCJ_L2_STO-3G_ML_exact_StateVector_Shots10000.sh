...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots10000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots10000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L2_STO-3G_ML_exact_StateVector_Shots10000.py"
echo "File run"
