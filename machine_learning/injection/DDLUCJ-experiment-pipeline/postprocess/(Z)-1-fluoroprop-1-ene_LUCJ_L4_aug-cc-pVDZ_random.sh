...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_random
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_random"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L4_aug-cc-pVDZ_random.py"
echo "File run"    
