...
#SBATCH -J water_LUCJ_L3_cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "water_LUCJ_L3_cc-pVDZ_zeroes_StateVector_Shots100000"
python "water_LUCJ_L3_cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
