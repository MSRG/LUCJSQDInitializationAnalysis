...
#SBATCH -J water_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots10000000
...
echo "water_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots10000000"
python "water_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
