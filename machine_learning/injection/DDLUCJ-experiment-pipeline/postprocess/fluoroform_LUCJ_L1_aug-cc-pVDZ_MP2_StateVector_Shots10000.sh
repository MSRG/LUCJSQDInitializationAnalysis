...
#SBATCH -J fluoroform_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots10000
...
echo "fluoroform_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots10000"
python "fluoroform_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots10000.py"
echo "File run"
