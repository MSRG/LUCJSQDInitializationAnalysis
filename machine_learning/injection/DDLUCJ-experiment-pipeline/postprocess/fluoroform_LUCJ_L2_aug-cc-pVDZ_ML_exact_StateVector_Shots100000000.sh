...
#SBATCH -J fluoroform_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots100000000
...
echo "fluoroform_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots100000000"
python "fluoroform_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots100000000.py"
echo "File run"
