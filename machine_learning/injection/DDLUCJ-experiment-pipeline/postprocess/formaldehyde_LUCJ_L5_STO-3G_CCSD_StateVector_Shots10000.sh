...
#SBATCH -J formaldehyde_LUCJ_L5_STO-3G_CCSD_StateVector_Shots10000
...
echo "formaldehyde_LUCJ_L5_STO-3G_CCSD_StateVector_Shots10000"
python "formaldehyde_LUCJ_L5_STO-3G_CCSD_StateVector_Shots10000.py"
echo "File run"
