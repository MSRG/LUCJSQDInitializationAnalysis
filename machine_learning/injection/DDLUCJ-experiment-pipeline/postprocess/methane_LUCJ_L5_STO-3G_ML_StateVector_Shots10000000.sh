...
#SBATCH -J methane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000000
...
echo "methane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000000"
python "methane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000000.py"
echo "File run"
