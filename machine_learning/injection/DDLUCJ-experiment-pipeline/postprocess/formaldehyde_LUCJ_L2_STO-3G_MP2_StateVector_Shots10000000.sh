...
#SBATCH -J formaldehyde_LUCJ_L2_STO-3G_MP2_StateVector_Shots10000000
...
echo "formaldehyde_LUCJ_L2_STO-3G_MP2_StateVector_Shots10000000"
python "formaldehyde_LUCJ_L2_STO-3G_MP2_StateVector_Shots10000000.py"
echo "File run"
