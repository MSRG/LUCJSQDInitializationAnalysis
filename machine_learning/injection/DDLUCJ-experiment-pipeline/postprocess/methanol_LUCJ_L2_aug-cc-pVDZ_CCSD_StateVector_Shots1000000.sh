...
#SBATCH -J methanol_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots1000000
...
echo "methanol_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots1000000"
python "methanol_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots1000000.py"
echo "File run"
