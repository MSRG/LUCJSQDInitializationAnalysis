...
#SBATCH -J fluoroform_LUCJ_L1_STO-3G_CCSD_StateVector_Shots100000000
...
echo "fluoroform_LUCJ_L1_STO-3G_CCSD_StateVector_Shots100000000"
python "fluoroform_LUCJ_L1_STO-3G_CCSD_StateVector_Shots100000000.py"
echo "File run"
