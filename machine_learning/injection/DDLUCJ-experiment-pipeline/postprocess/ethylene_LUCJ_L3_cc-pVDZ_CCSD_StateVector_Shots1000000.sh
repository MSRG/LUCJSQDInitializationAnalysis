...
#SBATCH -J ethylene_LUCJ_L3_cc-pVDZ_CCSD_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L3_cc-pVDZ_CCSD_StateVector_Shots1000000"
python "ethylene_LUCJ_L3_cc-pVDZ_CCSD_StateVector_Shots1000000.py"
echo "File run"
