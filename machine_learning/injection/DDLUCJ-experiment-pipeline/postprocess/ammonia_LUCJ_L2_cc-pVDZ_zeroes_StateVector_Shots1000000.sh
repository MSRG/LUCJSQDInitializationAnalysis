...
#SBATCH -J ammonia_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "ammonia_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots1000000"
python "ammonia_LUCJ_L2_cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
