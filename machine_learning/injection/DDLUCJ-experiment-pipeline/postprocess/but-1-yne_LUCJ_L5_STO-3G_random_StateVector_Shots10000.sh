...
#SBATCH -J but-1-yne_LUCJ_L5_STO-3G_random_StateVector_Shots10000
...
echo "but-1-yne_LUCJ_L5_STO-3G_random_StateVector_Shots10000"
python "but-1-yne_LUCJ_L5_STO-3G_random_StateVector_Shots10000.py"
echo "File run"
