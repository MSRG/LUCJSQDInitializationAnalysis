...
#SBATCH -J methane_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000
...
echo "methane_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000"
python "methane_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000.py"
echo "File run"
