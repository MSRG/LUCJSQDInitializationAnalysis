...
#SBATCH -J methane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000
...
echo "methane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000"
python "methane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000.py"
echo "File run"
