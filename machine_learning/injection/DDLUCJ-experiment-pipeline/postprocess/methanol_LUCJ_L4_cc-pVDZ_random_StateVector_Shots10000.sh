...
#SBATCH -J methanol_LUCJ_L4_cc-pVDZ_random_StateVector_Shots10000
...
echo "methanol_LUCJ_L4_cc-pVDZ_random_StateVector_Shots10000"
python "methanol_LUCJ_L4_cc-pVDZ_random_StateVector_Shots10000.py"
echo "File run"
