...
#SBATCH -J ethylene_LUCJ_L1_STO-3G_MP2_StateVector_Shots10000
...
echo "ethylene_LUCJ_L1_STO-3G_MP2_StateVector_Shots10000"
python "ethylene_LUCJ_L1_STO-3G_MP2_StateVector_Shots10000.py"
echo "File run"
