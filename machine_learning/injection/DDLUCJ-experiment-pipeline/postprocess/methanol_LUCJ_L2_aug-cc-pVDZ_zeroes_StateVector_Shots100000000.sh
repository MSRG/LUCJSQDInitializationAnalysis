...
#SBATCH -J methanol_LUCJ_L2_aug-cc-pVDZ_zeroes_StateVector_Shots100000000
...
echo "methanol_LUCJ_L2_aug-cc-pVDZ_zeroes_StateVector_Shots100000000"
python "methanol_LUCJ_L2_aug-cc-pVDZ_zeroes_StateVector_Shots100000000.py"
echo "File run"
