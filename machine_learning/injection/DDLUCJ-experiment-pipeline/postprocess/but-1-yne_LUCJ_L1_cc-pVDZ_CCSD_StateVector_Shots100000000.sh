...
#SBATCH -J but-1-yne_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots100000000
...
echo "but-1-yne_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots100000000"
python "but-1-yne_LUCJ_L1_cc-pVDZ_CCSD_StateVector_Shots100000000.py"
echo "File run"
