...
#SBATCH -J methanol_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000000
...
echo "methanol_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000000"
python "methanol_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000000.py"
echo "File run"
