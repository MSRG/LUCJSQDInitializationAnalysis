...
#SBATCH -J water_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots100000
...
echo "water_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots100000"
python "water_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots100000.py"
echo "File run"
