...
#SBATCH -J buta-1,3-diene_LUCJ_L5_aug-cc-pVDZ_ML_exact_StateVector_Shots100000
...
echo "buta-1,3-diene_LUCJ_L5_aug-cc-pVDZ_ML_exact_StateVector_Shots100000"
python "buta-1,3-diene_LUCJ_L5_aug-cc-pVDZ_ML_exact_StateVector_Shots100000.py"
echo "File run"
