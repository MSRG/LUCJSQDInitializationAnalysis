...
#SBATCH -J ethylene_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots10000
...
echo "ethylene_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots10000"
python "ethylene_LUCJ_L3_cc-pVDZ_ML_StateVector_Shots10000.py"
echo "File run"
