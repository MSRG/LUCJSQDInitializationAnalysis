...
#SBATCH -J water_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000000
...
echo "water_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000000"
python "water_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000000.py"
echo "File run"
