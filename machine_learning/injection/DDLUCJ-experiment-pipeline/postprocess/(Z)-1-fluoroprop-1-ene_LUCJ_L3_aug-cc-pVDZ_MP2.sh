...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L3_aug-cc-pVDZ_MP2
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L3_aug-cc-pVDZ_MP2"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L3_aug-cc-pVDZ_MP2.py"
echo "File run"    
