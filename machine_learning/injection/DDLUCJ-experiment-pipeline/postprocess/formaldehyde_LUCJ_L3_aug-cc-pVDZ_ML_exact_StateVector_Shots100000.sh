...
#SBATCH -J formaldehyde_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots100000
...
echo "formaldehyde_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots100000"
python "formaldehyde_LUCJ_L3_aug-cc-pVDZ_ML_exact_StateVector_Shots100000.py"
echo "File run"
