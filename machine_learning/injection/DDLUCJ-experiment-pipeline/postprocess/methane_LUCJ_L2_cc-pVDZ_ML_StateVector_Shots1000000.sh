...
#SBATCH -J methane_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "methane_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000"
python "methane_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
