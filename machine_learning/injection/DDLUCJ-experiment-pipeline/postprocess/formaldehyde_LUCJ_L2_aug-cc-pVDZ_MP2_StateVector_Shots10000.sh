...
#SBATCH -J formaldehyde_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots10000
...
echo "formaldehyde_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots10000"
python "formaldehyde_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots10000.py"
echo "File run"
