...
#SBATCH -J methane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots100000
...
echo "methane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots100000"
python "methane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots100000.py"
echo "File run"
