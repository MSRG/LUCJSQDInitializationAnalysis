...
#SBATCH -J methane_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots1000000
...
echo "methane_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots1000000"
python "methane_LUCJ_L5_aug-cc-pVDZ_random_StateVector_Shots1000000.py"
echo "File run"
