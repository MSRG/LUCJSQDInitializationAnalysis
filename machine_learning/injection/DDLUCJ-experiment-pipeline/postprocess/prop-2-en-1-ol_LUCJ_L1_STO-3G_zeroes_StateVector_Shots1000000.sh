...
#SBATCH -J prop-2-en-1-ol_LUCJ_L1_STO-3G_zeroes_StateVector_Shots1000000
...
echo "prop-2-en-1-ol_LUCJ_L1_STO-3G_zeroes_StateVector_Shots1000000"
python "prop-2-en-1-ol_LUCJ_L1_STO-3G_zeroes_StateVector_Shots1000000.py"
echo "File run"
