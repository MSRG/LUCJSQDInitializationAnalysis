...
#SBATCH -J methanol_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000
...
echo "methanol_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000"
python "methanol_LUCJ_L4_STO-3G_ML_exact_StateVector_Shots10000000.py"
echo "File run"
