...
#SBATCH -J methanol_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots10000
...
echo "methanol_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots10000"
python "methanol_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots10000.py"
echo "File run"
