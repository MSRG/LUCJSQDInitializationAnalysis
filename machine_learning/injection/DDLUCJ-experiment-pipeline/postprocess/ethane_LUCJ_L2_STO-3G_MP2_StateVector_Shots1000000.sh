...
#SBATCH -J ethane_LUCJ_L2_STO-3G_MP2_StateVector_Shots1000000
...
echo "ethane_LUCJ_L2_STO-3G_MP2_StateVector_Shots1000000"
python "ethane_LUCJ_L2_STO-3G_MP2_StateVector_Shots1000000.py"
echo "File run"
