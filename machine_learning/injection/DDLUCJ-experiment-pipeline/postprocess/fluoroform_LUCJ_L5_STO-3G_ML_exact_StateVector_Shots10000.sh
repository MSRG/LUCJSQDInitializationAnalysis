...
#SBATCH -J fluoroform_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000
...
echo "fluoroform_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000"
python "fluoroform_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots10000.py"
echo "File run"
