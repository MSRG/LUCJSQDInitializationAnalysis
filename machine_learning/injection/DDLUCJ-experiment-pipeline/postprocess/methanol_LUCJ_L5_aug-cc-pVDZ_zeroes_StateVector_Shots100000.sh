...
#SBATCH -J methanol_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "methanol_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000"
python "methanol_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
