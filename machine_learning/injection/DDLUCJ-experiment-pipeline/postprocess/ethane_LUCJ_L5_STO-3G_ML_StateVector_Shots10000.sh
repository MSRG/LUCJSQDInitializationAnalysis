...
#SBATCH -J ethane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000
...
echo "ethane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000"
python "ethane_LUCJ_L5_STO-3G_ML_StateVector_Shots10000.py"
echo "File run"
