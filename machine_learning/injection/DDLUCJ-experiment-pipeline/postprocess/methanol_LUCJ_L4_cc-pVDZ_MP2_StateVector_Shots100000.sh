...
#SBATCH -J methanol_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000
...
echo "methanol_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000"
python "methanol_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000.py"
echo "File run"
