...
#SBATCH -J ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000
...
echo "ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000"
python "ethylene_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots10000.py"
echo "File run"
