...
#SBATCH -J methane_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots100000000
...
echo "methane_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots100000000"
python "methane_LUCJ_L3_aug-cc-pVDZ_random_StateVector_Shots100000000.py"
echo "File run"
