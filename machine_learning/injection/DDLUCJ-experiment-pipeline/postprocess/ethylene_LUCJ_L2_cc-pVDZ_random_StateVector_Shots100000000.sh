...
#SBATCH -J ethylene_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000000
...
echo "ethylene_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000000"
python "ethylene_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000000.py"
echo "File run"
