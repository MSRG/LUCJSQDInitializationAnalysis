...
#SBATCH -J formaldehyde_LUCJ_L5_aug-cc-pVDZ_CCSD_StateVector_Shots100000000
...
echo "formaldehyde_LUCJ_L5_aug-cc-pVDZ_CCSD_StateVector_Shots100000000"
python "formaldehyde_LUCJ_L5_aug-cc-pVDZ_CCSD_StateVector_Shots100000000.py"
echo "File run"
