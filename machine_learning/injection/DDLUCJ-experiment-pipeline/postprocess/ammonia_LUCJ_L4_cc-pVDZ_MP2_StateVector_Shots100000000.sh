...
#SBATCH -J ammonia_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000000
...
echo "ammonia_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000000"
python "ammonia_LUCJ_L4_cc-pVDZ_MP2_StateVector_Shots100000000.py"
echo "File run"
