...
#SBATCH -J ethylene_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000"
python "ethylene_LUCJ_L2_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
