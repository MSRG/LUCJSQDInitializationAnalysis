...
#SBATCH -J ethylene_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots1000000"
python "ethylene_LUCJ_L4_cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
