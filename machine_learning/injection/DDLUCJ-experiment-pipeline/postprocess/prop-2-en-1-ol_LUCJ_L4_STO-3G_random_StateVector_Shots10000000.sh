...
#SBATCH -J prop-2-en-1-ol_LUCJ_L4_STO-3G_random_StateVector_Shots10000000
...
echo "prop-2-en-1-ol_LUCJ_L4_STO-3G_random_StateVector_Shots10000000"
python "prop-2-en-1-ol_LUCJ_L4_STO-3G_random_StateVector_Shots10000000.py"
echo "File run"
