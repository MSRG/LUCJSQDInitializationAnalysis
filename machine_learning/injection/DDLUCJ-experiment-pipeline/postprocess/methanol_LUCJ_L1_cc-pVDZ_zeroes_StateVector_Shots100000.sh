...
#SBATCH -J methanol_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "methanol_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000"
python "methanol_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
