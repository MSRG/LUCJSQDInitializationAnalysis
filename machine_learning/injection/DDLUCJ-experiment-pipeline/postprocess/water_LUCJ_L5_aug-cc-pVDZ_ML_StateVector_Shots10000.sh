...
#SBATCH -J water_LUCJ_L5_aug-cc-pVDZ_ML_StateVector_Shots10000
...
echo "water_LUCJ_L5_aug-cc-pVDZ_ML_StateVector_Shots10000"
python "water_LUCJ_L5_aug-cc-pVDZ_ML_StateVector_Shots10000.py"
echo "File run"
