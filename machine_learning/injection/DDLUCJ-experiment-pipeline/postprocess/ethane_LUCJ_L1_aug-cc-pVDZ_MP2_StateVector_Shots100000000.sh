...
#SBATCH -J ethane_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots100000000
...
echo "ethane_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots100000000"
python "ethane_LUCJ_L1_aug-cc-pVDZ_MP2_StateVector_Shots100000000.py"
echo "File run"
