...
#SBATCH -J ethane_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots1000000
...
echo "ethane_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots1000000"
python "ethane_LUCJ_L2_cc-pVDZ_CCSD_StateVector_Shots1000000.py"
echo "File run"
