...
#SBATCH -J ammonia_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000
...
echo "ammonia_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000"
python "ammonia_LUCJ_L3_cc-pVDZ_random_StateVector_Shots100000.py"
echo "File run"
