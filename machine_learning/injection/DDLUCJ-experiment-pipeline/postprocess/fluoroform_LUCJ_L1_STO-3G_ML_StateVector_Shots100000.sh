...
#SBATCH -J fluoroform_LUCJ_L1_STO-3G_ML_StateVector_Shots100000
...
echo "fluoroform_LUCJ_L1_STO-3G_ML_StateVector_Shots100000"
python "fluoroform_LUCJ_L1_STO-3G_ML_StateVector_Shots100000.py"
echo "File run"
