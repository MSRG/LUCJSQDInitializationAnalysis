...
#SBATCH -J ethylene_LUCJ_L5_STO-3G_random_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L5_STO-3G_random_StateVector_Shots1000000"
python "ethylene_LUCJ_L5_STO-3G_random_StateVector_Shots1000000.py"
echo "File run"
