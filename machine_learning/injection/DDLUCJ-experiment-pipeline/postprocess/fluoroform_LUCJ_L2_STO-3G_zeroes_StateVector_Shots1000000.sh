...
#SBATCH -J fluoroform_LUCJ_L2_STO-3G_zeroes_StateVector_Shots1000000
...
echo "fluoroform_LUCJ_L2_STO-3G_zeroes_StateVector_Shots1000000"
python "fluoroform_LUCJ_L2_STO-3G_zeroes_StateVector_Shots1000000.py"
echo "File run"
