...
#SBATCH -J fluoroform_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots100000
...
echo "fluoroform_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots100000"
python "fluoroform_LUCJ_L2_aug-cc-pVDZ_CCSD_StateVector_Shots100000.py"
echo "File run"
