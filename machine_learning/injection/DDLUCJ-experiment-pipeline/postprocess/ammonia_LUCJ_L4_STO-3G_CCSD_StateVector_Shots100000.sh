...
#SBATCH -J ammonia_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000
...
echo "ammonia_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000"
python "ammonia_LUCJ_L4_STO-3G_CCSD_StateVector_Shots100000.py"
echo "File run"
