...
#SBATCH -J methanol_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000000
...
echo "methanol_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000000"
python "methanol_LUCJ_L5_cc-pVDZ_zeroes_StateVector_Shots100000000.py"
echo "File run"
