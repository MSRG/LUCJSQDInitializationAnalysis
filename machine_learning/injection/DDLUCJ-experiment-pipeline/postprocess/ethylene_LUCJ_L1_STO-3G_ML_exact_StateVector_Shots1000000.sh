...
#SBATCH -J ethylene_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots1000000
...
echo "ethylene_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots1000000"
python "ethylene_LUCJ_L1_STO-3G_ML_exact_StateVector_Shots1000000.py"
echo "File run"
