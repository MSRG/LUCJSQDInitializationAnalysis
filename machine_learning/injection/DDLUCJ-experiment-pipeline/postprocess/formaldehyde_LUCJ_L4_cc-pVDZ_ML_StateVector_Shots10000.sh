...
#SBATCH -J formaldehyde_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots10000
...
echo "formaldehyde_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots10000"
python "formaldehyde_LUCJ_L4_cc-pVDZ_ML_StateVector_Shots10000.py"
echo "File run"
