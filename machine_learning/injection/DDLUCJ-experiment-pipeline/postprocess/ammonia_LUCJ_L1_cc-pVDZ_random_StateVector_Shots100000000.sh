...
#SBATCH -J ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots100000000
...
echo "ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots100000000"
python "ammonia_LUCJ_L1_cc-pVDZ_random_StateVector_Shots100000000.py"
echo "File run"
