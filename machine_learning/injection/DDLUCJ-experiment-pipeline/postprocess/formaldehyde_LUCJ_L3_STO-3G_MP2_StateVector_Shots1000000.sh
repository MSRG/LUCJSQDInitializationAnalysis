...
#SBATCH -J formaldehyde_LUCJ_L3_STO-3G_MP2_StateVector_Shots1000000
...
echo "formaldehyde_LUCJ_L3_STO-3G_MP2_StateVector_Shots1000000"
python "formaldehyde_LUCJ_L3_STO-3G_MP2_StateVector_Shots1000000.py"
echo "File run"
