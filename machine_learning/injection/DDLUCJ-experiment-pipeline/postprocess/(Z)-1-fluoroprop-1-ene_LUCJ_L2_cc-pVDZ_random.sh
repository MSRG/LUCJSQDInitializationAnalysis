...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L2_cc-pVDZ_random
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L2_cc-pVDZ_random"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L2_cc-pVDZ_random.py"
echo "File run"    
