...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_zeroes
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_zeroes"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L5_STO-3G_zeroes.py"
echo "File run"    
