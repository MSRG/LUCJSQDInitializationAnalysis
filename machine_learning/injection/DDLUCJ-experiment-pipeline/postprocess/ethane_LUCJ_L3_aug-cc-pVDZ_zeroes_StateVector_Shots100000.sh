...
#SBATCH -J ethane_LUCJ_L3_aug-cc-pVDZ_zeroes_StateVector_Shots100000
...
echo "ethane_LUCJ_L3_aug-cc-pVDZ_zeroes_StateVector_Shots100000"
python "ethane_LUCJ_L3_aug-cc-pVDZ_zeroes_StateVector_Shots100000.py"
echo "File run"
