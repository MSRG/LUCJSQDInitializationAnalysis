...
#SBATCH -J formaldehyde_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots1000000
...
echo "formaldehyde_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots1000000"
python "formaldehyde_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots1000000.py"
echo "File run"
