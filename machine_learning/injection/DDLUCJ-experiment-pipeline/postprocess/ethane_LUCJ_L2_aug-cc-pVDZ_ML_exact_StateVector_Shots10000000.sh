...
#SBATCH -J ethane_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000
...
echo "ethane_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000"
python "ethane_LUCJ_L2_aug-cc-pVDZ_ML_exact_StateVector_Shots10000000.py"
echo "File run"
