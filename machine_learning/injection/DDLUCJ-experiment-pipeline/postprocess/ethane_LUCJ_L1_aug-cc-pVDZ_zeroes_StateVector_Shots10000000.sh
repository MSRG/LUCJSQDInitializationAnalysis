...
#SBATCH -J ethane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots10000000
...
echo "ethane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots10000000"
python "ethane_LUCJ_L1_aug-cc-pVDZ_zeroes_StateVector_Shots10000000.py"
echo "File run"
