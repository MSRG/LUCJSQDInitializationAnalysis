...
#SBATCH -J formaldehyde_LUCJ_L4_STO-3G_random_StateVector_Shots1000000
...
echo "formaldehyde_LUCJ_L4_STO-3G_random_StateVector_Shots1000000"
python "formaldehyde_LUCJ_L4_STO-3G_random_StateVector_Shots1000000.py"
echo "File run"
