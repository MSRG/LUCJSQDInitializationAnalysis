...
#SBATCH -J ethane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000
...
echo "ethane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000"
python "ethane_LUCJ_L5_cc-pVDZ_ML_exact_StateVector_Shots10000.py"
echo "File run"
