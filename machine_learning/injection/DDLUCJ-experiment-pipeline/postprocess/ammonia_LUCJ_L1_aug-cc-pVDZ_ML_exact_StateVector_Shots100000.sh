...
#SBATCH -J ammonia_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots100000
...
echo "ammonia_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots100000"
python "ammonia_LUCJ_L1_aug-cc-pVDZ_ML_exact_StateVector_Shots100000.py"
echo "File run"
