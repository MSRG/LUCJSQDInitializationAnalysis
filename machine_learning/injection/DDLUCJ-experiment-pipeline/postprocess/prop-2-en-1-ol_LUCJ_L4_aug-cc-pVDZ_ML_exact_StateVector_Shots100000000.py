...
EnergyPath = "../energies/prop-2-en-1-ol_LUCJ_L4_aug-cc-pVDZ_ML_exact_StateVector_Shots100000000.txt"
with open(EnergyPath, 'w') as f:
    f.write(f"Basis Set: aug-cc-pVDZ\n")
    f.write(f"Molecule: prop-2-en-1-ol\n")
    f.write(f"Method: LUCJ(L=4)/ML_exact\n")
