...
#SBATCH -J methanol_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000
...
echo "methanol_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000"
python "methanol_LUCJ_L4_cc-pVDZ_ML_exact_StateVector_Shots1000000.py"
echo "File run"
