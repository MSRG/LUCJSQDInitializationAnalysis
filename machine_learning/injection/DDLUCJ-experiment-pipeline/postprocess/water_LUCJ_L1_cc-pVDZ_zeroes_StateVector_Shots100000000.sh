...
#SBATCH -J water_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000000
...
echo "water_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000000"
python "water_LUCJ_L1_cc-pVDZ_zeroes_StateVector_Shots100000000.py"
echo "File run"
