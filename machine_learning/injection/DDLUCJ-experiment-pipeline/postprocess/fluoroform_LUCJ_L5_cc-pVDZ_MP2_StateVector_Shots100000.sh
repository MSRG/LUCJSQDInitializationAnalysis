...
#SBATCH -J fluoroform_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots100000
...
echo "fluoroform_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots100000"
python "fluoroform_LUCJ_L5_cc-pVDZ_MP2_StateVector_Shots100000.py"
echo "File run"
