...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots100000000.py"
echo "File run"
