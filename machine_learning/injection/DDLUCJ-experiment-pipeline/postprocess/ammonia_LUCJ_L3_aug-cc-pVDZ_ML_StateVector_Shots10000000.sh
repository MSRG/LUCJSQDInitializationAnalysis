...
#SBATCH -J ammonia_LUCJ_L3_aug-cc-pVDZ_ML_StateVector_Shots10000000
...
echo "ammonia_LUCJ_L3_aug-cc-pVDZ_ML_StateVector_Shots10000000"
python "ammonia_LUCJ_L3_aug-cc-pVDZ_ML_StateVector_Shots10000000.py"
echo "File run"
