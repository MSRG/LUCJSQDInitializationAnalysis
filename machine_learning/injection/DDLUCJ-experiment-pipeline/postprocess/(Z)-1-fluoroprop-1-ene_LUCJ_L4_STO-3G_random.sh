...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_random
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_random"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_random.py"
echo "File run"    
