...
#SBATCH -J methanol_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots10000
...
echo "methanol_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots10000"
python "methanol_LUCJ_L5_cc-pVDZ_ML_StateVector_Shots10000.py"
echo "File run"
