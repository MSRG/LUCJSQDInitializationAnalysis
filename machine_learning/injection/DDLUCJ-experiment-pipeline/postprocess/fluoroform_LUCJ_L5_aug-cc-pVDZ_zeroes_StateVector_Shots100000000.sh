...
#SBATCH -J fluoroform_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000000
...
echo "fluoroform_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000000"
python "fluoroform_LUCJ_L5_aug-cc-pVDZ_zeroes_StateVector_Shots100000000.py"
echo "File run"
