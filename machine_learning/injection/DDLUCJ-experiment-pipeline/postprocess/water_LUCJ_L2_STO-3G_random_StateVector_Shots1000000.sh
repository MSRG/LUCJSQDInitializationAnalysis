...
#SBATCH -J water_LUCJ_L2_STO-3G_random_StateVector_Shots1000000
...
echo "water_LUCJ_L2_STO-3G_random_StateVector_Shots1000000"
python "water_LUCJ_L2_STO-3G_random_StateVector_Shots1000000.py"
echo "File run"
