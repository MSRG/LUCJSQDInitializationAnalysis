...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_MP2_StateVector_Shots10000000
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_MP2_StateVector_Shots10000000"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L4_STO-3G_MP2_StateVector_Shots10000000.py"
echo "File run"
