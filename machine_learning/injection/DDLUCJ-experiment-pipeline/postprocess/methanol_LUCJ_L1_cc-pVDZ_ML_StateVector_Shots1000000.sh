...
#SBATCH -J methanol_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "methanol_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000"
python "methanol_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
