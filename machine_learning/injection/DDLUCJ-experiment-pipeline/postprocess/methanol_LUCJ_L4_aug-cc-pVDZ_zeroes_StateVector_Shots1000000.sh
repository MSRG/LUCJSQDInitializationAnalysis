...
#SBATCH -J methanol_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000
...
echo "methanol_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000"
python "methanol_LUCJ_L4_aug-cc-pVDZ_zeroes_StateVector_Shots1000000.py"
echo "File run"
