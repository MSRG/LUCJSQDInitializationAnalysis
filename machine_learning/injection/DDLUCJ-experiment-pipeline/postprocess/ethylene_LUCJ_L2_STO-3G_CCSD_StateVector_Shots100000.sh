...
#SBATCH -J ethylene_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000
...
echo "ethylene_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000"
python "ethylene_LUCJ_L2_STO-3G_CCSD_StateVector_Shots100000.py"
echo "File run"
