...
#SBATCH -J ethane_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000
...
echo "ethane_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000"
python "ethane_LUCJ_L2_cc-pVDZ_random_StateVector_Shots100000.py"
echo "File run"
