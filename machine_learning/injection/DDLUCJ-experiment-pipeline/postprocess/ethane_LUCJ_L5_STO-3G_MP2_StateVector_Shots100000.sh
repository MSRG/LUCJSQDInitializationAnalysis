...
#SBATCH -J ethane_LUCJ_L5_STO-3G_MP2_StateVector_Shots100000
...
echo "ethane_LUCJ_L5_STO-3G_MP2_StateVector_Shots100000"
python "ethane_LUCJ_L5_STO-3G_MP2_StateVector_Shots100000.py"
echo "File run"
