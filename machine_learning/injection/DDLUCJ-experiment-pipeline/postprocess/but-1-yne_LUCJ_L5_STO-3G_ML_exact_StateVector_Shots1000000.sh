...
#SBATCH -J but-1-yne_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots1000000
...
echo "but-1-yne_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots1000000"
python "but-1-yne_LUCJ_L5_STO-3G_ML_exact_StateVector_Shots1000000.py"
echo "File run"
