...
#SBATCH -J fluoroform_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots10000000
...
echo "fluoroform_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots10000000"
python "fluoroform_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots10000000.py"
echo "File run"
