...
#SBATCH -J ethane_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000000
...
echo "ethane_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000000"
python "ethane_LUCJ_L2_STO-3G_zeroes_StateVector_Shots100000000.py"
echo "File run"
