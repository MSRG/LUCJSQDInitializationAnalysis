...
#SBATCH -J (Z)-1-fluoroprop-1-ene_LUCJ_L5_aug-cc-pVDZ_ML
...
echo "(Z)-1-fluoroprop-1-ene_LUCJ_L5_aug-cc-pVDZ_ML"
python "(Z)-1-fluoroprop-1-ene_LUCJ_L5_aug-cc-pVDZ_ML.py"
echo "File run"    
