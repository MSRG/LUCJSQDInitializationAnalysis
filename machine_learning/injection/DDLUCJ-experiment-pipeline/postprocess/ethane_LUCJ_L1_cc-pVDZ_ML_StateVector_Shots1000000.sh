...
#SBATCH -J ethane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000
...
echo "ethane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000"
python "ethane_LUCJ_L1_cc-pVDZ_ML_StateVector_Shots1000000.py"
echo "File run"
