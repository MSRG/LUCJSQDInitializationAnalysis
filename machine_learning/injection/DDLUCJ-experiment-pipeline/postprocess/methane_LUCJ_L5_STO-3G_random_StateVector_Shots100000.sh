...
#SBATCH -J methane_LUCJ_L5_STO-3G_random_StateVector_Shots100000
...
echo "methane_LUCJ_L5_STO-3G_random_StateVector_Shots100000"
python "methane_LUCJ_L5_STO-3G_random_StateVector_Shots100000.py"
echo "File run"
