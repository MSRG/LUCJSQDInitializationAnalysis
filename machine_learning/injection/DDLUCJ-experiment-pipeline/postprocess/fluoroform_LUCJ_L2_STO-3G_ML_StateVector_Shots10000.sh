...
#SBATCH -J fluoroform_LUCJ_L2_STO-3G_ML_StateVector_Shots10000
...
echo "fluoroform_LUCJ_L2_STO-3G_ML_StateVector_Shots10000"
python "fluoroform_LUCJ_L2_STO-3G_ML_StateVector_Shots10000.py"
echo "File run"
