...
#SBATCH -J ethane_LUCJ_L3_STO-3G_random_StateVector_Shots10000000
...
echo "ethane_LUCJ_L3_STO-3G_random_StateVector_Shots10000000"
python "ethane_LUCJ_L3_STO-3G_random_StateVector_Shots10000000.py"
echo "File run"
