...
#SBATCH -J methane_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots100000000
...
echo "methane_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots100000000"
python "methane_LUCJ_L2_aug-cc-pVDZ_MP2_StateVector_Shots100000000.py"
echo "File run"
