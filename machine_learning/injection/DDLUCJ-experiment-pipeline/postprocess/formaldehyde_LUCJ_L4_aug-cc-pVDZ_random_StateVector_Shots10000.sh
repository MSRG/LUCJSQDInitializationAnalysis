...
#SBATCH -J formaldehyde_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots10000
...
echo "formaldehyde_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots10000"
python "formaldehyde_LUCJ_L4_aug-cc-pVDZ_random_StateVector_Shots10000.py"
echo "File run"
